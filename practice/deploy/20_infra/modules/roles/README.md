...
This module creates IAM roles with trust policies for GitHub Actions, enabling GitHub Actions workflows to assume roles and perform Terraform operations.
...
- `aws_iam_role_policy_attachment`: Policy attachments for the roles
...
module "github_actions_roles" {
  ...
  terraform_plan_policy_arn = module.terraform_policies.terraform_plan_policy_arn
  terraform_apply_policy_arn = module.terraform_policies.terraform_apply_policy_arn
...
|------|------|-------------|---------|----------|
| `oidc_provider_arn` | `string` | ARN of the OIDC provider | - | Yes |
| `github_organization` | `string` | GitHub organization name | - | Yes |
| `github_repository` | `string` | GitHub repository name | - | Yes |
| `create_terraform_plan_role` | `bool` | Whether to create the plan role | `true` | No |
| `create_terraform_apply_role` | `bool` | Whether to create the apply role | `true` | No |
...
| `terraform_plan_policy_arn` | `string` | ARN of the plan policy | - | Yes |
| `terraform_apply_policy_arn` | `string` | ARN of the apply policy | - | Yes |
...
| Name | Description |
|------|-------------|
| `terraform_plan_role_arn` | ARN of the Terraform plan role (use in GitHub Secret `AWS_ROLE_ARN`) |
| `terraform_apply_role_arn` | ARN of the Terraform apply role |
| `terraform_plan_role_name` | Name of the Terraform plan role |
| `terraform_apply_role_name` | Name of the Terraform apply role |
