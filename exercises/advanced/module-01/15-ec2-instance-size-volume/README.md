...
2. Add validation to the instance type variable to ensure that the instance type is either `t2.micro`, `t3.micro`, or `t3.large`. If a different value is used, Terraform should return an error message stating that "Only t2.micro, t3.micro, and t3.large instances are supported".
...
**Note:** The complete solution for this exercise can be found in the `solution/` directory of exercise 14, which contains all the progressive changes from exercises 14-21.
...
2. Add validation to the instance type variable: Add a `validation` block within the variable to ensure that the instance type is either `t2.micro`, `t3.micro`, or `t3.large`. If a different value is used, Terraform should return an error message stating that "Only t2.micro, t3.micro, and t3.large instances are supported". This helps maintain the consistency and integrity of the infrastructure.
